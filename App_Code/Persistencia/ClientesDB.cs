...
public class ClientesDB
{
    public static int Insert(Clientes clientes)
    {
        ...
        try
        {
            ...
            string sql = "insert into cli_cliente(cli_nome,cli_email, cli_celular, cli_senha, cli_sexo,cli_data_nascimento) " +
                "values(?cli_nome, ?cli_email, ?cli_celular, ?cli_senha, ?cli_sexo, ?cli_data_nascimento); select last_insert_id();";
            ...
            objCommand.Parameters.Add(Mapped.Parameter("?cli_celular", clientes.Cli_celular));
    ...
    public static int Update(Clientes cliente)
    {
        ...
        try
        {
            ...
            string sql = "update cli_cliente set cli_nome = ?cli_nome, cli_email = ?cli_email, cli_celular = ?cli_celular, " +
                "cli_senha = ?cli_senha, cli_sexo = ?cli_sexo, cli_data_nascimento = ?cli_data_nascimento, " +
                "cli_foto_url = ?cli_foto_url where cli_id = ?cli_id";
            objConnection = Mapped.Connection();
            objCommand = Mapped.Command(sql, objConnection);
            ...
            objCommand.Parameters.Add(Mapped.Parameter("?cli_celular", cliente.Cli_celular));
